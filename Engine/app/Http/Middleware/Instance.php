...
class Instance
{
    ...
    public function handle($request, Closure $next){
        $statusesArr = [
            // Instances
            'status','qr_code','logout','takeover','expiry','retry','reboot','settings','updateSettings','outputIP','me','updateName','updateStatus','repeatHook','labelsList','createLabel','updateLabel','removeLabel',
