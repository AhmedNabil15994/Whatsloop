...
class TemplatesControllers extends Controller {
    ...
    public function edit($id) {
        ...
        $userObj = Template::NotDeleted()->find($id);
        if($userObj == null) {
            return Redirect('404');
        }

        $data['data'] = Template::getData($userObj);
        $data['designElems'] = $this->getData();
        $data['designElems']['mainData']['title'] = trans('main.edit') . ' '.trans('main.templates') ;
    ...
    public function update($id) {
        ...
        $input = \Request::all();
        // dd($input);
        $dataObj = Template::NotDeleted()->find($id);
        if($dataObj == null) {
            return Redirect('404');
        }
    ...
    public function add() {
        $data['designElems'] = $this->getData();
        $data['designElems']['mainData']['title'] = trans('main.add') . ' '.trans('main.templates') ;
    ...
    public function create() {
        ...
        $dataObj->description_ar = $input['description_ar'];
        $dataObj->description_en = $input['description_en'];
        $dataObj->sort = Template::newSortIndex();
    ...
    public function sort(){
        ...
        for ($i = 0; $i < count($ids) ; $i++) {
            Template::where('id',$ids[$i])->update(['sort'=>$sorts[$i]]);
        }
