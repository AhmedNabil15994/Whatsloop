                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item-parent">
                                        <div class="adding-card">
                                            ...
                                            <div class="card-body">
                                                <span class="tooltip">{{ $extraQuota->extraTypeText }}</span>
                                                <div class="cardtop">
                                                    <h5 class="card-title">{{ $extraQuota->extra_count . ' '.$extraQuota->extraTypeText . ' ' . ($extraQuota->extra_type == 1 ? trans('main.msgPerDay') : '')}}</h5>
