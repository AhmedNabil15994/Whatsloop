        ...
        <div class="col-md-8">
            <div class="form">
                <div class="card-body">
                    ...
                    <form class="formPayment" method="POST" action="{{ URL::to('/botPlus/update/'.$data->data->id) }}">
                        @csrf
                                    ...
                                    <div class='col-md-9'>
                                        <div class='row'>
                                            ...
                                            <div class='col-md-4 repy'>
                                                <textarea class="{{ $oneItem['msg_type'] == 0 ? '' : 'hidden'  }}" name='btn_reply_{{ $oneItem['id'] }}' placeholder='{{ trans('main.messageContent') }}'>{{ $oneItem['msg_type'] == 0 ? json_decode($oneItem['msg']) : ''  }}</textarea>
