...
<div class="container-fluid">
    <form class="form-horizontal" method="POST" action="{{ URL::to('/groups/update/'.$data->data->id) }}">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" value="{{ $data->data->name_ar }}" name="name_ar" id="inputEmail3" placeholder="{{ trans('main.name_ar') }}">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputPassword3" class="col-3 col-form-label">{{ trans('main.name_en') }} :</label>
                            <div class="col-9">
                                <input type="text" class="form-control" value="{{ $data->data->name_en }}" name="name_en" id="inputPassword3" placeholder="{{ trans('main.name_en') }}">
                                                ...
                                                <div class="card permission">
                                                    <div class="card-header">
                                                        ...
                                                        <label class="ckbox prem">
                                                            <input type="checkbox" name="allPermission" {{ in_array($allPerm[array_keys($allPerm)[0]]['perm_name'], $data->data->rulesArr) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-2 mb-2">
                                                                <label class="ckbox prem">
                                                                    <input type="checkbox" name="permission{{ $onePerm['perm_name'] }}" {{ in_array($one, $data->data->rulesArr) ? 'checked' : '' }}>
