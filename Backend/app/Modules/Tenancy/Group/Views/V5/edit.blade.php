                ...
                <div class="form">
                    ...
                    <div class="formPayment">                        
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $data->data->name_ar }}" name="name_ar" id="inputEmail3" placeholder="{{ trans('main.name_ar') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">                            
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $data->data->name_en }}" name="name_en" id="inputPassword3" placeholder="{{ trans('main.name_en') }}">
