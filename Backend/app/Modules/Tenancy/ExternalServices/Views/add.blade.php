                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal grpmsg" method="POST" action="{{ URL::to('/services/'.$data->designElems['mainData']['service'].'/templates/create/') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <textarea name="content_ar" class="form-control" placeholder="{{ trans('main.content_ar') }}">{{ old('content_ar') }}</textarea>
                            </div>
                        </div> 
                        <div class="form-group row mb-3">
                            <label class="col-3 col-form-label">{{ trans('main.content_en') }} :</label>
                            <div class="col-9">
                                <textarea name="content_en" class="form-control" placeholder="{{ trans('main.content_en') }}">{{ old('content_en') }}</textarea>
                            </div>
                        </div> 
                        <div class="form-group row mb-3">
