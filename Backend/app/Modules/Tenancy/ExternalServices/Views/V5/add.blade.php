        ...
        <div class="col-md-8">
            <div class="form">
                <div class="card-body">
                    ...
                    <form class="formPayment grpmsg" method="POST" action="{{ URL::to('/services/'.$data->designElems['mainData']['service'].'/templates/create/') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea name="content_ar" placeholder="{{ trans('main.content_ar') }}">{{ old('content_ar') }}</textarea>
                            </div>
                        </div> 
                        <div class="form-group row mb-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <textarea name="content_en" placeholder="{{ trans('main.content_en') }}">{{ old('content_en') }}</textarea>
                            </div>
                        </div> 
                        <div class="form-group row mb-3">
                            <div class="col-md-3">
                      ...
                      <div class="mainScreen bloqueado">
                        ...
                        <div class="conversation">
                            <div class="conversation-container overflowY clearfix">    
                                <div class="message received break-space" style="margin-top: 70px;"></div>
                            </div>
                        </div>
