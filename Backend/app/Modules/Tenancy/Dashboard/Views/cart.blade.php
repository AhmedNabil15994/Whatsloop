                        ...
                        <table class="table table-bordered borderTop">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right"><span class="grandTotal">{{ number_format((float)$actual_price, 2, '.', '') }}</span> {{ trans('main.sar') }}</td>
                                </tr>
                                <tr>
                                    <td class="text-left"><span>{{ trans('main.estimatedTax') }}</span></td>
                                    <td class="text-right text-muted"><span class="estimatedTax">{{ number_format((float)$tax, 2, '.', '') }}</span> {{ trans('main.sar') }}</td>
                                </tr>
                                <tr>
                                    <td class="text-left"><span>{{ trans('main.total') }}</span></td>
                                    <td class="text-right"><span class="total">{{ number_format((float)$data->membership->monthly_after_vat, 2, '.', '') }}</span> {{ trans('main.sar') }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
