...
<div class="row row-sm">
    <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
        <div class="card text-center">
            <a href="{{ URL::to('/dashboard') }}" title="">
                <div class="card-body ">
                    <div class="feature widget-2 text-center mt-0 mb-3">
                        <img src="{{ asset('images/dashboard.svg') }}" alt="">
                    </div>
                    <h6 class="mb-1 text-muted">{{ trans('main.dashboard') }}</h6>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
        <div class="card text-center">
            <a href="{{ URL::to('/whatsappOrders/orders') }}" title="">
                <div class="card-body ">
                    <div class="feature widget-2 text-center mt-0 mb-3">
                        <img src="{{ asset('images/whatsapp.svg') }}" alt="">
                    </div>
                    <h6 class="mb-1 text-muted">{{ trans('main.whatsappOrders') }}</h6>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
        <div class="card text-center">
            <a href="{{ URL::to('/helpCenter') }}" title="">
                <div class="card-body ">
                    <div class="feature widget-2 text-center mt-0 mb-3">
                        <img src="{{ asset('images/help.svg') }}" alt="">
                    </div>
                    <h6 class="mb-1 text-muted">{{ trans('main.helpCenter') }}</h6>
                </div>
            </a>
        </div>
    </div>
