...
<html lang="{{ LANGUAGE_PREF }}" dir="{{ DIRECTION }}">
    <head>
        ...
        <link href="{{ asset('V5/css/toastr.min.css') }}" rel="stylesheet" type="text/css">
        <!--[if lt IE 9]>
    ...
    <body>
        ...
        <div class="loginPage clearfix">
            ...
            <div class="left">
                <img src="{{ asset('V5/images/loginBg.png') }}" alt="" />
            </div>
        </div>
        ...
        <script src="{{ asset('V5/components/login.js') }}" type="text/javascript"></script>
