...
<form class="formInfo formBank formMargin" method="POST" action="{{ URL::to('/orders/'.$data->order->order_id.'/bankTransfer') }}" enctype="multipart/form-data">
    @csrf
    <div class="container">
        ...
        <div class="inputStyle mapStyle uploadStyle">
            ...
            <label class="upload">
                ...
                <img src="{{ asset('designs/2/images/cloud.png') }}" alt="" />
            </label>
        </div>
