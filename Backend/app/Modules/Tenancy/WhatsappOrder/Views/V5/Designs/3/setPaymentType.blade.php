...
<form class="products selectPayment" method="POST" action="{{ URL::current() }}">
    @csrf
    <div class="container clearfix inputStyle" id="formSelect2">
        <h2 class="titleStyle">خيارات الدفع</h2>
