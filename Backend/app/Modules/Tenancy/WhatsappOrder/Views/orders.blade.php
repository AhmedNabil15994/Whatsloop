            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                <div class="product-card card overflow-hidden">
                    <div class="col" style="padding:0;"> 
                        <h3 class="text-center ">{{ trans('main.order').': '.$order->order_id }}</h3>
                    </div>
                    <div class="card-body h-100">
                        <h3 class="h6 mb-2 font-weight-bold text-uppercase" dir="ltr">
                            {{ $order->client }}
                        ...
                        <a class="btn btn-primary btn-block mb-0 mt-4" target="_blank" href="{{ URL::current().'/'.base64_encode($order->order_id) }}">
                            <i class="fe fe-eye mr-1"></i>
                            {{ trans('main.info') }}
                        </a>
                        @if($order->status == 1)
                        <a class="btn btn-success btn-block mb-0 mt-1" target="_blank" href="#">
                            <i class="fe fe-send mr-1"></i>
                            {{ trans('main.sendLinkToClient') }}
                        </a>
                        @endif
                    </div>
                </div>
