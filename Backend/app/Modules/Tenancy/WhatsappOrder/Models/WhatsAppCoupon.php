...
class WhatsAppCoupon extends Model{
    ...
    static function getData($source) {
        ...
        $data->discount_typeText = trans('main.discount_type_'.$source->discount_type);
        $data->valid_typeText = trans('main.valid_type_'.$source->valid_type);
