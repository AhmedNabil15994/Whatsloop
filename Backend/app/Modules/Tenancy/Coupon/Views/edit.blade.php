        ...
        <div class="col-xs-12">
            <div class="form">
                <div class="card-body">
                    ...
                    <form class="formPayment" method="POST" action="{{ URL::to('/'.$data->designElems['mainData']['url'].'/update/'.$data->data->id) }}">
                        @csrf
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="" value="{{ $data->data->code }}" name="code" id="inputEmail3" placeholder="{{ trans('main.coupon_code') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <select name="discount_type" class="" data-toggle="select2">
                                    <option value="1" {{ $data->data->discount_type == 1 ? 'selected' : '' }}>{{ trans('main.discount_type_1') }}</option>
                                    <option value="2" {{ $data->data->discount_type == 2 ? 'selected' : '' }}>{{ trans('main.discount_type_2') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input class="" type="text" name="discount_value" value="{{ $data->data->discount_value }}" maxlength="" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <select name="valid_type" class="" data-toggle="select2">
                                    <option value="1" {{ $data->data->valid_type == 1 ? 'selected' : '' }}>{{ trans('main.valid_type_1') }}</option>
                                    <option value="2" {{ $data->data->valid_type == 2 ? 'selected' : '' }}>{{ trans('main.valid_type_2') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input class=" mb-5 datetimepicker-inputs" type="text" name="valid_value" value="{{ $data->data->valid_value }}">
                            </div>
                        </div>
                        <hr class="mt-5">
                        <div class="row">
