        ...
        <div class="col-md-8">
            <div class="form">
                <div class="card-body">
                    ...
                    <form class="formPayment" method="POST" action="{{ URL::to('/bots/create') }}">
                        @csrf
                        ...
                        <div class="reply" data-id="1">
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="messageContent"> {{ trans('main.messageContent') }}</label>                   
                                </div>
                                <div class="col-md-9">
                                    <textarea name="replyText" placeholder="{{ trans('main.messageContent') }}">{{ old('reply') }}</textarea>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div class="reply" data-id="5">
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="url"> {{ trans('main.url') }}</label>            
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="urlTitle"> {{ trans('main.urlTitle') }}</label>            
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="urlDesc"> {{ trans('main.urlDesc') }}</label>            
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="urlImage"> {{ trans('main.urlImage') }}</label>            
                                </div>
                                <div class="col-md-9">
                                    <div class="dropzone kt_dropzone_1">
                                        <div class="fallback">
                        ...
                        <div class="reply" data-id="6">
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="whatsappNo"> {{ trans('main.whatsappNo') }}</label>            
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="reply" data-id="7">
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="lat"> {{ trans('main.lat') }}</label>            
                                </div>
                                <div class="col-md-9">
                                    <input type="text" value="{{ old('lat') }}" name="lat" placeholder="{{ trans('main.lat') }}">
                                </div>
                            </div>
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="lng"> {{ trans('main.lng') }}</label>            
                                </div>
                                <div class="col-md-9">
                                    <input type="text" value="{{ old('lng') }}" name="lng" placeholder="{{ trans('main.lng') }}">
                                </div>
                            </div>
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="location"> {{ trans('main.location') }}</label>            
                                </div>
                                <div class="col-md-9">
                                    <input type="text" value="{{ old('address') }}" name="address" placeholder="{{ trans('main.location') }}">
                                </div>
                            </div>
                        </div>
                        <div class="reply" data-id="8">
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="webhookURL"> {{ trans('main.webhookURL') }}</label>            
                                </div>
                                <div class="col-md-9">
                                    <input type="text" value="{{ old('webhook_url') }}" name="webhook_url" placeholder="{{ trans('main.webhookURL') }}">
                                </div>
                            </div>
                            <div class="row hidden">
                                <div class="col-md-3">
                                    <label class="titleLabel" for="sentTemplates"> {{ trans('main.sentTemplates') }}</label>            
                                </div>
                                <div class="col-md-9">
