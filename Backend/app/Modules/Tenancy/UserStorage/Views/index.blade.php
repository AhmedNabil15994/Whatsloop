            ...
            <div class="card-box">
                ...
                <div class="inbox-leftbar">
                    <div class="mail-list mt-3">
                        ...
                        <a href="{{ URL::to('/storage/bots') }}" class="list-group-item border-0 {{ Active(URL::to('/storage/bots*')) }}"><i class="fas fa-robot font-18 align-middle mr-2"></i>{{ trans('main.bot') }}</a>
                        <a href="{{ URL::to('/storage/groupMsgs') }}" class="list-group-item border-0 {{ Active(URL::to('/storage/groupMsgs*')) }}"><i class="mdi mdi-send font-18 align-middle mr-2"></i>{{ trans('main.groupMsgs') }}</a>
                        <a href="{{ URL::to('/storage/chats') }}" class="list-group-item border-0 {{ Active(URL::to('/storage/chats*')) }}"><i class="mdi mdi-forum-outline font-18 align-middle mr-2"></i>{{ trans('main.livechat') }}</a>
                    </div>
                    <div class="mt-5">
