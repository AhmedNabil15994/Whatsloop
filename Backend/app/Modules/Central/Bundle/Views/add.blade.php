                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ URL::to('/'.$data->designElems['mainData']['url'].'/create') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <textarea class="form-control summernote" name="description_ar" placeholder="{{ trans('main.descriptionAr') }}">{{ old('description_ar') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputPassword3" class="col-3 col-form-label">{{ trans('main.descriptionEn') }} :</label>
                            <div class="col-9">
                                <textarea class="form-control summernote" name="description_en" placeholder="{{ trans('main.descriptionEn') }}">{{ old('description_en') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
