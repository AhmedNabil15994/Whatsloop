...
<div class="container-fluid">
    ...
    @if($data->designElems['mainData']['url'] == 'groupMsgs' || $data->designElems['mainData']['url'] == 'tickets' || $data->designElems['mainData']['url'] == 'clients' || $data->designElems['mainData']['url'] == 'invoices')
