                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ URL::to('/'.$data->designElems['mainData']['url'].'/create') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <select class="form-control" data-toggle="select2" name="user_id">
                                    ...
                                    <option value="{{ $user->id }}" {{ old('user_id') == $user->id ? 'selected' : '' }} data-dom="{{ $user->domain }}">{{ $user->channel . ' - ' . $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" value="{{ old('webhook_url') }}" name="webhook_url" disabled placeholder="Webhook URL">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputPassword3" class="col-3 col-form-label">Client ID :</label>
                            <div class="col-9">
                                <input type="text" class="form-control" value="{{ old('client_id') }}" name="client_id" placeholder="Client ID">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputPassword3" class="col-3 col-form-label">Client Secret :</label>
                            <div class="col-9">
                                <input type="text" class="form-control" value="{{ old('client_secret') }}" name="client_secret" placeholder="Client Secret">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputPassword3" class="col-3 col-form-label">Webhook Secret :</label>
                            <div class="col-9">
                                <input type="text" class="form-control" value="{{ old('webhook_secret') }}" name="webhook_secret" placeholder="Webhook Secret">
                            </div>
                        </div>
