...
<html lang="{{ LANGUAGE_PREF }}" dir="{{ DIRECTION }}">
    <head>
        ...
        <title>واتس لووب | Whats Loop | {{ trans('main.code') }}</title>
    ...
    <body>
        ...
        <div class="loginPage clearfix">
            <div class="right">
                ...
                <div class="center">
                   <form class="formLogin" action="{{ URL::to('/checkAvailabilityCode') }}" method="post">
                        @csrf
                        <h2 class="title">{{ trans('auth.code') }}</h2>
                        <input type="hidden" name="phone" value="{{ $data->phone }}">
                        <div class="inputStyle">
                            <input class="code" type="tel" name="code" placeholder="{{ trans('auth.codePlaceHolder') }}" />
