    ...
    <body>
        ...
        <div class="loginPage clearfix">
            <div class="right">
                ...
                <div class="center">
                    <form class="formLogin" action="{{ URL::current() }}" method="post">
                        @csrf
                        <h2 class="title">{{ trans('main.checkAvailability') }}</h2>
        ...
        <script src="{{ asset('tenancy/assets/V5/components/checkAvailability.js') }}" type="text/javascript"></script>
