                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ URL::to('/'.$data->designElems['mainData']['url'].'/update/'.$data->data->id) }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" value="{{ $data->data->code }}" name="code" id="inputEmail3" placeholder="{{ trans('main.coupon_code') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input class="form-control" type="text" name="discount_value" value="{{ $data->data->discount_value }}" maxlength="" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input class="form-control mb-5 datetimepicker-inputs" type="text" name="valid_value" value="{{ $data->data->valid_value }}">
                            </div>
                        </div>
