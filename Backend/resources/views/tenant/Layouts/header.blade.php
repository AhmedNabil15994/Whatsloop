    ...
    <div class="container-fluid">
        <div class="main-header-left">
            <div class="responsive-logo">
                <a href="index.html"><img src="{{ asset('img/brand/logo.png') }}" class="logo-1 logo-color1" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/logo2.png') }}" class="logo-1 logo-color2" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/logo3.png') }}" class="logo-1 logo-color3" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/logo4.png') }}" class="logo-1 logo-color4" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/logo5.png') }}" class="logo-1 logo-color5" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/logo6.png') }}" class="logo-1 logo-color6" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/logo-white.png') }}" class="dark-logo-1" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/favicon.png') }}" class="logo-2 logo-color1" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/favicon2.png') }}" class="logo-2 logo-color2" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/favicon3.png') }}" class="logo-2 logo-color3" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/favicon4.png') }}" class="logo-2 logo-color4" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/favicon5.png') }}" class="logo-2 logo-color5" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/favicon6.png') }}" class="logo-2 logo-color6" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('img/brand/favicon-white.png') }}" class="dark-logo-2" alt="logo"></a>
            </div>
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
               ...
               {{--  <div class="dropdown nav-item main-header-notification">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    @php
                    $image = \App\Models\User::getData(\App\Models\User::getOne(USER_ID))->photo;
                    @endphp
