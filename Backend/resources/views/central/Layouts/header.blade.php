    ...
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown d-lg-inline-block topbar-dropdown">
                <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ DIRECTION == 'ltr' ? asset('tenancy/assets/images/flags/us.jpg') : asset('tenancy/assets/images/flags/ksa.png') }}" alt="user-image" height="16">
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item lang-item">
                        <img src="{{ asset('tenancy/assets/images/flags/us.jpg') }}" alt="user-image" class="mr-1" height="12"> <span class="align-middle">{{ trans('main.english') }}</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item lang-item">
                        <img src="{{ asset('tenancy/assets/images/flags/ksa.png') }}" alt="user-image" class="mr-1" height="12"> <span class="align-middle">{{ trans('main.arabic') }}</span>
                    </a>
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    @php 
                        $userObj = \App\Models\CentralUser::getData(\App\Models\CentralUser::getOne(USER_ID));
                    @endphp
        ...
        <div class="logo-box">
            <a href="{{ URL::to('/dashboard') }}" class="logo logo-dark text-center">
                <span class="logo-sm">
                    <img src="{{ asset('tenancy/assets/images/favicon.ico') }}" alt="" height="22">
                    <!-- <span class="logo-lg-text-light">UBold</span> -->
                </span>
                <span class="logo-lg">
                    <img src="{{ asset('tenancy/assets/images/logo.png') }}" alt="" height="35">
