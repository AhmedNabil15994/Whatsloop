    ...
    <div class="container-fluid">
        <div class="main-header-left">
            <div class="responsive-logo">
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/logo.png') }}" class="logo-1 logo-color1" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/logo2.png') }}" class="logo-1 logo-color2" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/logo3.png') }}" class="logo-1 logo-color3" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/logo4.png') }}" class="logo-1 logo-color4" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/logo5.png') }}" class="logo-1 logo-color5" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/logo6.png') }}" class="logo-1 logo-color6" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/logo-white.png') }}" class="dark-logo-1" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/favicon.png') }}" class="logo-2 logo-color1" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/favicon2.png') }}" class="logo-2 logo-color2" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/favicon3.png') }}" class="logo-2 logo-color3" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/favicon4.png') }}" class="logo-2 logo-color4" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/favicon5.png') }}" class="logo-2 logo-color5" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/favicon6.png') }}" class="logo-2 logo-color6" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('tenancy/assets/img/brand/favicon-white.png') }}" class="dark-logo-2" alt="logo"></a>
            </div>
